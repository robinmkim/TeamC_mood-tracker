    ...
    <div class="m-4">
        ...
        <div class="postImage relative mb-3">
            <div class="flex items-center justify-center relative">
                <div class="h-60 overflow-hidden relative rounded-lg flex  items-center justify-center">
                    <img :src="getImageUrl(currentImageIndex)" alt="Post image" class="items-center rounded-lg"/>
                </div>
                <a v-if="currentImageIndex > 1" 
                    class="absolute top-1/2 transform -translate-y-1/2 cursor-pointer left-2.5 text-white"
                    @click="prevImage">
                    &#10094;
                </a>
                <a v-if="currentImageIndex < imageCount" 
        ...
        <div>
            ...
            <div class="flex flex-row">
                <div class="flex items-center">
                    <svg id="likeButton" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6" @click="handleSvgClick">
                    <path ref="likePath" stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                    </svg>
                    <span @click="handleSvgClick" class="text-sm ml-1">55</span>
                    <span class="ml-2">&#128519;</span> <!-- 이모티콘 -->
                </div>
            </div>
        </div>
