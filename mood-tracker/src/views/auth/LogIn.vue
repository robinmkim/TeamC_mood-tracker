<template>
  <div class="flex items-center justify-center h-full p-6">
    <div class="flex h-[580px] mt-36 items-center">
      <img
        src="../../assets/login_infoImg.gif"
        class="rounded-lg h-[530px] w-[725px]"
      />
    </div>
    <div class="flex items-center justify-center h-full p-6 w-[450px] mt-36">
